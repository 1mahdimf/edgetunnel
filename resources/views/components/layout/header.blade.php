<header class="relative mb-4 bg-white border-t-4 border-t-cyan-400 shadow  dark:bg-darker">
    <div class="flex items-center justify-between px-4 p-2 border-b dark:border-blue-800">
        <!-- Mobile menu button -->
        ...
        <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
            ...
            <button aria-hidden="true" class="relative focus:outline-none" @click="toggleTheme">
                ...
                <div class="absolute top-0 left-0 inline-flex items-center justify-center w-6 h-6 transition-all duration-150 transform scale-110 rounded-full shadow-sm translate-x-0 -translate-y-px bg-white text-blue-700"
        ...
        <nav x-transition:enter="transition duration-200 ease-in-out transform sm:duration-500"
            ...
            <div class="space-x-2">
                ...
                <button aria-hidden="true" class="relative focus:outline-none" @click="toggleTheme">
                    ...
                    <div class="absolute top-0 left-0 inline-flex items-center justify-center w-6 h-6 transition-all duration-200 transform scale-110 rounded-full shadow-sm translate-x-0 -translate-y-px bg-white text-blue-700"
                        :class="{ 'translate-x-0 -translate-y-px  bg-white text-blue-700': !isDark, 'translate-x-6 text-blue-100 bg-blue-800': isDark }">
                        <svg x-show="!isDark" class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="border-b md:hidden dark:border-blue-800" x-show="isMobileMainMenuOpen"
        ...
        <nav aria-label="Main" class="px-2 py-4 space-y-2">
            ...
            <div x-data="{ isActive: true, open: true }">
                <!-- active classes 'bg-blue-100 dark:bg-blue-600' -->
                <a href="#" @click="$event.preventDefault(); open = !open"
                    class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-blue-100 dark:hover:bg-blue-600 bg-blue-100 dark:bg-blue-600"
                    :class="{ 'bg-blue-100 dark:bg-blue-600': isActive || open }" role="button" aria-haspopup="true"
